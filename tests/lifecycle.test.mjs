...
const { defaultConfig } = await import("../scripts/seed-config.mjs");
const { seedTemplates } = await import("../scripts/seed-templates.mjs");
const { emptyCounters } = await import("../src/domain/numbering.js");
const { computeTotals } = await import("../src/domain/document.js");
const { formatMoney } = await import("../src/domain/money.js");
